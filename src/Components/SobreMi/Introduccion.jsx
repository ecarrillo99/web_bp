    ...
    return (
        <div id='biografia' className='flex flex-col md:flex-row mx-auto max-w-6xl py-6 sm:px-6 lg:px-8 w-full mt-7'>
            <div className='w-full md:w-1/2 mb-6 md:mb-0'>
                <img src='./images/sobre-mi.png' alt="Bernardo Polo Andrade" className='max-w-full h-auto'></img>
            </div>
            <div className='w-full md:w-1/2 flex flex-col gap-2 justify-center px-4 md:px-6'>
                <label className='text-xl md:text-2xl font-semibold'>Sobre Mí</label>
                <label className='text-xl md:text-2xl font-bold italic text-[#769842]'>"Se cuenta una historia, que debe ser interesante, atractiva y que perdure con los años."</label>
