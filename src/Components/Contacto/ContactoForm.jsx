...
const LoadingFallback = () => (
  <div className="bg-gradient-to-b from-teal-50 to-gray-100 py-16 flex justify-center items-center min-h-[400px]">
    <div className="text-center">
      <div className="inline-block animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#96c121]"></div>
      <p className="mt-4 text-gray-600">Cargando formulario de contacto...</p>
    </div>
  </div>
);

const FormularioContacto = lazy(() => {
        ...
        <div className='bg-gradient-to-b from-teal-50 to-gray-100 py-16'>
            <div className='flex flex-col md:flex-row mx-auto max-w-6xl sm:px-6 lg:px-8 w-full gap-8 lg:gap-16 px-4 relative overflow-hidden'>
                ...
                <Suspense fallback={<LoadingFallback />}>
                    <InfoContacto whatsappLink={whatsappLink} />
                </Suspense>
